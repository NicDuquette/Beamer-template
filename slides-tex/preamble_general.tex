...
\end{frame}
	...
	% Whole-page Stata code block. Need to explain further.
%\newcommand{\MyStataCode}{No code defined yet!}
%\newcommand{\MakeStataFrame}[2]{\begin{frame}\frametitle{#1}\MyStataCode{}\end{frame}}
%
%
