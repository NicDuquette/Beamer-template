...
\newcommand{\InsertStataFrame}[3]{\begin{frame}\frametitle{#1} {#2 \inputminted[style=mydark,bgcolor=xbg,obeytabs=true,tabsize=4]{stata}{#3}} \end{frame}}
\newcommand{\InsertPythonFrame}[2]{\begin{frame}\frametitle{#1} {\footnotesize \inputminted[style=mydark,bgcolor=xbg,,obeytabs=true,tabsize=4]{python}{#2}} \end{frame}}
